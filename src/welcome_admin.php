...
<html lang="en">
    ...
    <body>
        <header>
            <h1 class="site-heading text-center text-faded d-none d-lg-block">
                <span class="site-heading-upper text-primary mb-3" text-color="cream">Delicacy. Elegance. </span>
                        ...
                        <div class="cta-inner bg-faded text-center rounded">
                            <h2 class="section-heading mb-5">
                                ...
                                <span class="section-heading-lower">
                                    <canvas id="myCanvas" width="300" height="70" style="border:4px solid #ffdab9;">
                                    ...
                                    <script>
                                        ...
                                        ctx.font = "30px Arial";
                                        ctx.strokeText("Welcome admin!", 35, 45);
                                    </script>
                                </span>
                            </h2>
    ...
    <p>Now you can add, edit and delete products on your site.</p>
    <p><a href="index.php" class="btn btn-info">Return to Home page.</a></p>
    <p><a href="products_admin.php" class="btn btn-info">Go to Products.</a></p>
                        </div>
                    </div>
                </div>
            </div>
